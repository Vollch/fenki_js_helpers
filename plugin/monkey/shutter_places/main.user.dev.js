...
})(window,document,'script',(6 == document.location.protocol.length ? 'https:' : 'http:') + '//cdn.rawgit.com/Vollch/fenki_js_helpers/gh-pages/plugin/monkey/shutter_places/window_helper.dev.js','getElementsByTagName');
